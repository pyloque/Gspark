...
public class MockCodisStore extends CodisStore {
	...
	public static class MockResponse<T> extends Response<T> {
		private T data;
		private JedisDataException exc;

		public MockResponse(T data) {
			super(null);
			this.data = data;
		}

		public MockResponse(JedisDataException exc) {
			super(null);
			this.exc = exc;
		}
	...
	public MockCodisStore mockHash() {
	...
	public MockCodisStore mockZset() {
	...
	public MockCodisStore mockList() {
	...
	public MockCodisStore mockShare() {
	...
	public MockCodisStore mockMore(Consumer<Jedis> func) {
		func.accept(jedis);
		return this;
	}
